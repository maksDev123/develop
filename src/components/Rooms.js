...
const Rooms = (props) => {
  ...
  const verify = (e, room_number, user_id) => {
    ...
    axios.post('https://maksym137.pythonanywhere.com/verify', { room_n: room_number, u_id: user_id })
  }
  useEffect(() => {
    setLoading(true)
    axios.get(`https://maksym137.pythonanywhere.com/curator_rooms/${props.user_id}`)
      .then(res => {
        console.log(res)
